...
export default function ReadingEntry() {
  ...
  useEffect(() => {
    ...
    console.log("[MysticStudio] Saving reading draft:", readingDraft);
    ...
    try {
      ...
      console.log(
        "[MysticStudio] Stored reading draft:",
        window.localStorage.getItem("mysticstudio.readingDraft"),
      );
    } catch (error) {
      console.error("[MysticStudio] Failed to save reading draft:", error);
    }
  }, [form]);
  ...
  function goNext() {
    ...
    if (isLastStep) {
      console.log(
        "[MysticStudio] Entering room with draft:",
        window.localStorage.getItem("mysticstudio.readingDraft"),
      );
